...
import com.shrutislegion.finapt.Customer.CustomerChatDetailsActivity
import com.shrutislegion.finapt.Modules.LoggedInUserInfo
import com.shrutislegion.finapt.R

class CustomerChatUserFragmentAdapter(var storeUsers: ArrayList<LoggedInUserInfo>, val context: Context): RecyclerView.Adapter<CustomerChatUserFragmentAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.pChatCardView.setOnClickListener {
            ...
            val intent = Intent(holder.pChatCardView.context, CustomerChatDetailsActivity::class.java)
